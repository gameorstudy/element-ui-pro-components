...
<table style="display: table">
  ...
  <tr>
    <td>onParams</td>
    <td><code>查询</code>、<code>重置</code>、<code>分页</code>、<code>排序</code> 触发，获取查询参数</td>
  ...
  <tr>
    <td>onKeyChange</td>
    <td>列设置（排序、重置）导致的表格重新渲染完成的回调</td>
    <td>
      <code>() => void</code>
    </td>
    <td>-</td>
...
##### columnsConfig 列定义
下面列出了与 <a href="https://element.eleme.io/2.15/#/zh-CN/component/form#form-item-attributes" target="_blank">el-table-column attributes</a> 不同的 API。
<table style="display: table">
  <tr>
    <th style="width: 100px">参数</th>
    <th>说明</th>
