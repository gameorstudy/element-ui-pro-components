...
;// external "element-ui-pro-components/lib/locale"
var locale_namespaceObject = require("element-ui-pro-components/lib/locale");
var locale_default = /*#__PURE__*/__webpack_require__.n(locale_namespaceObject);
    ...
    submitterProps() {
      if (this.submitter) {
        ...
        const defaultTextConfig = {
          resetText: (0,locale_namespaceObject.t)('elPro.proForm.reset'),
          submitText: (0,locale_namespaceObject.t)('elPro.proForm.submit')
        };
  ...
  computed: {
    ...
    submitterProps() {
      if (this.submitter) {
        // 配置按钮文本
        const defaultTextConfig = {
          cancelText: (0,locale_namespaceObject.t)('elPro.dialogForm.cancel'),
          confirmText: (0,locale_namespaceObject.t)('elPro.dialogForm.confirm')
        };
...
/* harmony default export */ var ColumnAlignSettingsvue_type_script_lang_js = ({
  ...
  methods: {
     ...
     */
    t(key) {
      return (0,locale_namespaceObject.t)(key);
    },
    /**
     * @desc 监听修改
  ...
  computed: {
    ...
    title() {
      ...
      if (Array.isArray(columns) && columns.length) {
        ...
        return fixed === "left" ? (0,locale_namespaceObject.t)('elPro.tableToolBar.leftFixedTitle') : fixed === "right" ? (0,locale_namespaceObject.t)('elPro.tableToolBar.rightFixedTitle') : (0,locale_namespaceObject.t)('elPro.tableToolBar.noFixedTitle');
      }
      return "";
    },
    // 是否支持拖动
...
/* harmony default export */ var pro_table_srcvue_type_script_lang_js = ({
  ...
  computed: {
    ...
    searchProps() {
      ...
      if (search) {
        const defaultSearch = {
          searchText: (0,locale_namespaceObject.t)('elPro.proTable.search'),
          resetText: (0,locale_namespaceObject.t)('elPro.proTable.reset'),
          labelWidth: "80px",
          rowProps: {
            gutter: 8
          },
    ...
    initializedColumnSettings() {
      ...
      if (columnSettings) {
        const defaultColumnSettings = {
          columnSetting: (0,locale_namespaceObject.t)('elPro.tableToolBar.columnSetting'),
          columnDisplay: (0,locale_namespaceObject.t)('elPro.tableToolBar.columnDisplay'),
          resetText: (0,locale_namespaceObject.t)('elPro.tableToolBar.reset'),
          draggable: true,
          checkable: true
        };
...
;// ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./packages/editable-pro-table/src/components/Editable.vue?vue&type=style&index=1&id=2f6b337e&prod&lang=css
// extracted by mini-css-extract-plugin
  ...
  computed: {
    ...
    initializedCreatorProps() {
      ...
      if (recordCreatorProps) {
        const defaultRecordCreatorProps = {
          position: 'bottom',
          newRecordType: 'cache',
          creatorButtonText: (0,locale_namespaceObject.t)('elPro.editableProTable.add'),
          onlyAddOneLineAlertMessage: (0,locale_namespaceObject.t)('elPro.editableProTable.onlyAddOneLine')
        };
    ...
    initializedEditable() {
      const defaultEditable = {
        type: 'single',
        saveText: (0,locale_namespaceObject.t)('elPro.editableProTable.save'),
        deleteText: (0,locale_namespaceObject.t)('elPro.editableProTable.delete'),
        cancelText: (0,locale_namespaceObject.t)('elPro.editableProTable.cancel'),
        deletePopconfirmMessage: (0,locale_namespaceObject.t)('elPro.editableProTable.deleteThisLine'),
        onlyOneLineEditorAlertMessage: (0,locale_namespaceObject.t)('elPro.editableProTable.onlyOneLineEditor')
      };
      return {
        ...defaultEditable,
        ...this.editable
...
;// ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./packages/editable-pro-table/src/index.vue?vue&type=style&index=1&id=1d66f59f&prod&lang=css
// extracted by mini-css-extract-plugin
